...
input_file = os.path.join('data-bin/XNLI-1.0', 'others_to_en.tsv') # 'xnli.test.tsv' or 'others_to_en.tsv'

output_dir = 'output'
model_dir = '7.5B'
# test_lang = 'en'
test_lang = sys.argv[1]
output_name = "twelve_shot_{}_translated_zero_shot.txt".format(test_lang)
